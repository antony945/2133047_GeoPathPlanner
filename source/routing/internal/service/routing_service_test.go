...
func TestRoutingService_HandleRoutingRequest(t *testing.T) {
	tests := []struct {
        ...
        {
            name: "RR-Complete-DifferentAltitudeWps-AntPath",
            foundRoute: true,
            input: models.MustNewRoutingRequestFromJson(`{
                "request_id": "1",
                "waypoints": [
        ...
        {
            name: "RR-Complete-SameAltitudeWps-RRT",
            foundRoute: true,
            input: models.MustNewRoutingRequestFromJson(`{
                "request_id": "1",
                "waypoints": [
        ...
        {
            name: "RR-Complete-DifferentAltitudeWps-RRT",
            foundRoute: true,
            input: models.MustNewRoutingRequestFromJson(`{
                "request_id": "1",
                "waypoints": [
        ...
        {
            name: "RR-Complete-SameAltitudeWps-RRTStar",
            foundRoute: true,
            input: models.MustNewRoutingRequestFromJson(`{
                "request_id": "1",
                "waypoints": [
        ...
        {
            name: "RR-Complete-DifferentAltitudeWps-RRTStar",
            foundRoute: true,
            input: models.MustNewRoutingRequestFromJson(`{
                "request_id": "1",
                "waypoints": [
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, found := rs.HandleRoutingRequest(tt.input, validator.NewDefaultValidator())
            ...
            if found != tt.foundRoute {
				t.Errorf("HandleRoutingRequest() found route? %v, want %v", found, tt.foundRoute)
			}
		})
	}
}
